...
public final class ViewVenda extends javax.swing.JFrame {
    ...
    private void listarProdutos(){
        ...
        listaProdutoses.stream().forEach((listaProdutose) -> {
            jcbProdutos.addItem(listaProdutose.getNome());
        });
    }
    ...
    private void listarClientes(){
        ...
        for (ModelCliente listaModelCliente : listaModelClientes) {
            jcbClientes.addItem(listaModelCliente.getNome());
        }
    }
    ...
    private static class ModelCaixa {

        public ModelCaixa() {
        }

        private float getDinheiro() {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }

        private void setDinheiro(float f) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
    }
